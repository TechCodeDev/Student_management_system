...
echo "<b><tr><td>" . "Application-number   ". "</td><td>" . "Amount-paid" . "</td><td>";// "Date of pay" . "</td><td>"."phone number" . "</td><td>". "Amount-paid" . "</td><td>";// "phnumber" . "</td><td>". "Category" . "</td><td>". "Citezenship" . "</td><td>"."Permanent Address" . "</td><td>"."Residential Address"."</td><td></b>"; 
while(! feof($handle))
 {   
     $raj=fgets($handle);
     $pattern = explode("|",$raj);
     ...
     if(is_numeric($pattern[0]))
     {
        ...
        echo "<tr><td>" . $pattern[0]  . "</td><td>" . $pattern[1]." </td><td>";/*. $pattern[2]. "</td><td>".$pattern[3]. "</td><td>". $pattern[4]. "</td><td>".$pattern[5]. "</td><td>";//$pattern[6]."</td><td>".$pattern[7]."</td><td>".$pattern[8]."</td><td>".$pattern[9]."</td><td>".$pattern[10]."</td><td>";*/ 
